/**
Javascript module to collect survey scams
...
var casper = require('casper').create({
	...
	//Initialize the browser to claim specific browser version
...
//finding all the frames on the target page
var frameLevel = 'root';
...
// recording page start 
casper.on('load.started', function() {
    this.startTime = new Date();
});

//recording resource request time
...
//recording the remote resouce retrieval
